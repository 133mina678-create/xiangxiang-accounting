...
begin
 ...
 perform public.change_book(secret,0,ids[1],'event.save',jsonb_build_object('id',ev,'name','台北三天兩夜','start_date','2026-09-25','end_date','2026-09-27','note','一起吃好吃的，剩下的交給香香。','members',to_jsonb(ids)));
